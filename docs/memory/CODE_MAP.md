...
| client/src/views/SwarmView.jsx | default SwarmView | Layout shell for the Swarm Orchestrator page. Toolbar: title, executionStatus indicator, Run/Stop/Pause/Resume/Reset buttons. Run button disabled+tooltip when preconditions unmet (Task #112). runError state removed (Task #113 — BUG-TOOLBAR-1). Reset also clears workflowDef (Task #113 — BUG-TOOLBAR-4). handlePause/handleResume guard against null activeExecutionId to prevent /null/ URL (Task #115 — BUG-TOOLBAR-3). (Tasks #57.2, #60, #66, #101, #103, #105, #106, #107, #112, #113, #115) |
