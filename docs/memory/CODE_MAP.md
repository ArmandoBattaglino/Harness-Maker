...
_Last updated: 2026-04-11 - after V17.5 Pack Operator Product Surface - mapped by code-mapper_

> **PROJECT STATUS: V17.5 PACK OPERATOR PRODUCT SURFACE CLOSED**
> Pack Library/Detail/Run surfaces provide pack-first launch and monitoring with explicit project binding and optional debug drawer. Verification: client operator/runtime 28/28 PASS; server pack runtime/history 27/27 PASS; build 510 modules.
...
| client/src/views/PackLibraryView.jsx | default PackLibraryView | V17.5 operator-first pack surface. Lists packs, shows detail/inputs/outputs/artifacts/version/status, renders generated run form from inputSchema, requires explicit project binding, launches pack starts, displays visible-step timeline/artifacts, and exposes advanced debug drawer. |
