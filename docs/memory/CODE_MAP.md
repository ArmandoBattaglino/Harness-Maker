...
_Last updated: 2026-04-06 — after Tasks #231 (BUG-WF-1) and #232 (BUG-WF-3) — V5.0 debugger loop fixes — mapped by code-mapper_
...
- **Last modified:** 2026-04-06 in Task #232 by debugger (BUG-WF-3: key={ptyExplosionNodeId} on PtyExplosion forces remount on agent switch; prior: Task #122 by frontend-dev)
