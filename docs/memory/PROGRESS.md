...
**Deliverables:**
- Added workflow-native `inputContract` and `outputContract` persistence with legacy defaults.
- Direct workflow runs now submit validated `workflowInput`, inject submitted inputs/expected outputs into runtime context, and hydrate `workflowRun` / `workflowResult` through status, results, and execution history.
- Swarm UI now provides workflow-native input launch form plus visible run I/O summary.
- Workflow settings now has an Interface tab for inputs, canonical outputs, and artifacts.
- Agent Inspector now exposes lightweight skill/context/expected-output guidance; runtime prompts surface that guidance while keeping it wave-1 non-hard-enforcement.
- Added deterministic Playwright workflow-first smoke and kept existing pack smoke green to prove pack surfaces remain intact.

**Verification:**
- Full server suite: **667/667 PASS**.
- Full client suite: **93/93 PASS**.
- Client build: **522 modules PASS**.
- Targeted workflow-heart Playwright smoke: **PASS**.
- Existing V17 pack Playwright smoke: **PASS**.
- `git diff --check`: **PASS** (LF->CRLF warnings only).
- Runtime diagnostics on touched files/project: **0 errors** (`tsc skipped: no tsconfig found` caveat).
...
---
Ã¯Â»Â¿## Marketing Video Harness Deep/Stress Test (2026-04-11)
...
---
## V17.0 Ã¢â‚¬â€ Pack Platform Program Foundation (2026-04-11)

**Status:** CLOSED Ã¢â‚¬â€ tasks **#610-#616** are now **COMPLETED/PASS** in the planning contract.
...
---
## V12.0 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Fan-In Workflow Fix (2026-04-10)

**Status:** CLOSED ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â tasks **#528ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“#535** all **COMPLETED** / **PASS** (8 tasks).
...
## V11.1 ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â Repetitive Handoff Loop Detection (2026-04-10)

**Status:** CLOSED ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â tasks **#511ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Å“#516** all **COMPLETED** / **PASS** (6 tasks).
...
- [FRONTEND-DEV 2026-04-09] TASK #435 (BUG-CHAT-CLIENT-10) COMPLETED. Added canonicalReceived guard in useSwarm.js REST hydration loop ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â skips assistant fragments for nodes with canonical already received. Build clean (507 modules).
...
- [BACKEND-DEV 2026-04-08] TASK #354 (SPIKE ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â stream-json multi-turn validation) COMPLETED. Created server/spike/stream-json-spike.mjs: standalone script testing 3 turns (basic, --resume, --tools restriction), timing, cost, JSONL discovery. Syntax OK. 414/414 tests pass. Awaiting TASK #355 TEST GATE execution.
...
- [V5.0-BugFix1 COMPLETED 2026-04-06] E2E Context Menu + Keyboard Shortcut Fixes. 3 bugs found during Debugger Loop Phase 1 E2E testing, all fixed and verified: BUG-CTX-1 (node right-click showed canvas menu ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â fixed with stopPropagation in SwarmCanvas.jsx handleNodeContextMenu), BUG-CTX-2 (edge right-click showed canvas menu ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â fixed with stopPropagation in handleEdgeContextMenu), BUG-KEYS-1 (Ctrl+S stale closure ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â fixed with ref-based function references in SwarmView.jsx). Tasks #282-#286 all COMPLETED. TEST GATE #285 PASS. AREA CHECKPOINT #286 PASS. Build: 487 modules, 0 errors. Tests: 312/312 pass. AREA CLOSED.
...
- [V5.0 PRD PLANNING COMPLETE 2026-04-06] PRD updated from v3.0 to v5.0 with "N8N-Style Visual Workflow Editor" addendum. 81 new functional requirements (FR-V5-01 through FR-V5-81), 5 implementation waves, 6 new node types (conditional, merge, delay, loop, errorHandler, subWorkflow), 5 new security requirements (SEC-V5-01 through SEC-V5-05). New API endpoints planned: workflow versions, execution history, templates, agent discovery. New UI components planned: NodePalette, ContextMenu, EdgeInspector, WorkflowSettingsModal, WorkflowToolbar, etc. No code changes ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â planning/design only. Next: task planning for V5 Wave 1.

- [V7.0 TASK #255 COMPLETED 2026-04-06] BUG-SNIPPET-INIT-1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Wrapped snippet update in SwarmEngine.js tapFn inside ignoreParserUntil guard. System prompt text no longer flashes in agent card during echo gate. 312/312 tests pass. TEST GATE #257 pending.

- [V7.0 TASK #254 COMPLETED 2026-04-06] BUG-DONE-BARE-1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â DONE_RE regex widened in HandoffParser.js to accept bare DONE on its own line. All HandoffParser tests pass. TEST GATE #256 pending.
...
- [V4.0.4 AREA CLOSED 2026-04-06] TASK #205 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â AREA CHECKPOINT PASS. V4.0.4 IS CLOSED.
...
- [V4.0.4 TEST GATE PASS 2026-04-06] TASK #204 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â TEST GATE PASS for BUG-RECOVERY-LABELING-1
...
- [PM STATUS SYNC 2026-04-06] Wave 4/5 transition ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â #202 PASS, #203 COMPLETED (no code change), #204+#205 launched:
  V4.0.4 chain nearly complete. #203 resolved without code change ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â existing sanitization pipeline already handles
  ...
  Wave 5 launched: #204 (TEST GATE) + #205 (AREA CHECKPOINT) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â both IN_PROGRESS.
  After #205 passes, V4.0.4 will be CLOSED. Only #148 (V3.4 AREA CHECKPOINT) remains as the last open task.

- [V4.0.4 TASK #203 COMPLETED 2026-04-06] BUG-RECOVERY-LABELING-1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â no code change needed.
...
- [V4.0.4 TEST GATE PASS 2026-04-06] TASK #202 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â TEST GATE PASS for BUG-PTY-REPLAY-CONTAMINATION-1
...
- [PM STATUS SYNC 2026-04-06] Wave 3 verified ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â #200 PASS, #223 PASS (V4.5 CLOSED), #201 COMPLETED:
...
- [V4.0.4 FIX 2026-04-06] TASK #201 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â BUG-PTY-REPLAY-CONTAMINATION-1 fixed
...
- [V4.0.4 TEST GATE PASS 2026-04-06] TASK #200 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â TEST GATE PASS for BUG-TOKEN-FIDELITY-1
...
- [PM STATUS SYNC 2026-04-06] Wave 2 verified ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 4 tasks confirmed COMPLETED:
  #187 PASS (V4.0.2 AREA CHECKPOINT ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â V4.0.2 CLOSED), #217 PASS (V4.4 AREA CHECKPOINT ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â V4.4 CLOSED),
  #199 COMPLETED (no bug ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â control tokens already preserved), #222 PASS (V4.5 TEST GATE).
...
- [V4.5 AREA CLOSED 2026-04-06] TASK #223 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â AREA CHECKPOINT PASS. 312/312 tests, 107/107 swarm-engine, build OK. All V4.5 tasks resolved. Snippet pipeline fully verified. V4.5 AREA IS CLOSED.

- [PM STATUS SYNC 2026-04-06] Wave 1 verified ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 8 parallel tasks confirmed COMPLETED:
...
- [V4.0.2 AREA CLOSED 2026-04-06] TASK #187 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â AREA CHECKPOINT PASS. 312/312 tests, build OK. All 6 Gemini E2E PTY/UI bugs verified fixed: PtyExplosion live output, ring buffer TUI sanitization, blocker false-positive suppression, snippet protocol filtering, InterAgentFeed icons. No regressions.

- [V4.0.4 TASK #199 COMPLETED 2026-04-06] Verified no change needed ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â control tokens __DONE__ and __HANDOFF__ are already preserved literally throughout the full pipeline (server snippet generation, WS broadcast, client rendering). Not a bug. TEST GATE #200 can proceed.

# Progress
- [V4.5 TEST GATE PASS 2026-04-06] TASK #222 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â TEST GATE PASS for V4.5 Snippet Fidelity MVP Blockers
...
- [V4.4 AREA CLOSED 2026-04-06] TASK #217 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â AREA CHECKPOINT PASS. 312/312 tests, build OK. Thinking animations + hook output filtering verified in SNIPPET_NOISE_LINE_PATTERNS. V4.4 Snippet Fidelity Final Polish is CLOSED.

- [V4.0.4 TEST GATE PASS 2026-04-06] TASK #198 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â TEST GATE PASS for BUG-SNIPPET-FIDELITY-1
...
- [V4.0.2 TEST GATE PASS 2026-04-06] TASK #184 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â TEST GATE BUG-SNIPPET-PROTOCOL-1 PASS
...
- [V4.5 FIX CLOSED 2026-04-06] TASK #218 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â BUG-SNIPPET-CONPTY-SPACES marked COMPLETED after review
  _decompressConPTYSpaces() heuristic handles mixed-case English text and punctuation-separated text. Known limitation:
  all-lowercase text (Italian prose) unsolvable without dictionary ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â accepted as platform constraint. 312/312 tests pass.
- [V4.3 AREA CLOSED 2026-04-06] TASK #213 COMPLETED PASS ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â AREA CHECKPOINT for V4.3 E2E Deep Test Round 2
...
- [V4.0.2 TEST GATE PASS 2026-04-06] TASK #186 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â TEST GATE PASS for BUG-FEED-ICON-1
...
- [V4.0.2 TEST GATE PASS 2026-04-06] TASK #178 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â TEST GATE PASS for BUG-PTY-EXPLOSION-1
...
- [V4.4 TEST GATE PASS 2026-04-06] TASK #216 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â TEST GATE PASS for V4.4 Snippet Fidelity
...
- [V5.2 AREA CLOSED 2026-04-06] TASK #244 COMPLETED PASS ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â AREA CHECKPOINT for V5.2 Swarm Deep Test Bug Fixes
...
- [V5.2 TEST GATE PASS 2026-04-06] TASK #243 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â TEST GATE PASS for all V5.2 bug fixes
...
- [V5.2 WAVE 1 COMPLETE 2026-04-06] Tasks #238, #239, #240, #241 ALL COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â V5.2 Wave 1 done
...
- [V5.2 FIX 2026-04-06] TASK #239 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â BUG-SWARM-UI-2 stale execution hydration 404 cleared
...
- [V5.2 FIX 2026-04-06] TASK #238 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â BUG-SWARM-API-1 malformed JSON returns 400 not 500
...
- [V5.2 FIX 2026-04-06] TASK #241 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â BUG-SWARM-API-2 API 404 catch-all before SPA fallback
  Unmatched /api/* paths now return JSON 404 instead of HTML 200. 312/312 tests pass.

- [V5.2 FIX 2026-04-06] TASK #240 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â BUG-SWARM-UI-3 rate limiter relaxed from 200 to 300 req/min
  Normal rapid view switching no longer triggers 429 errors. 312/312 tests pass.

- [V5.2 PLAN 2026-04-06] Debugger Loop Phase 2 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Swarm Deep Test Bug Fixes bulk plan created
  Tasks #238-#244 added to TASK_PLAN.md. 5 bugs from Phase 1 E2E testing. MEDIUM: #238 (malformed JSON 500ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢400), #239 (stale execution hydration 404). LOW: #240 (rate limiter too strict), #241 (SPA catch-all for API paths). DEFERRED: #242 (duplicate workflow names). TEST GATE #243, AREA CHECKPOINT #244. Wave 1: #238+#239+#240+#241 in parallel. Wave 2: #243. Wave 3: #244.

- [V5.1 AREA CHECKPOINT VERIFIED 2026-04-06] Task #237 AREA CHECKPOINT PASS ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â V5.1 CLOSED
...
- [V5.1 AREA CLOSED 2026-04-06] V5.1 Debugger Loop Full-App Deep Check ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â CLOSED
...
- [V5.1 PM REVIEW 2026-04-06] TASK #234 VERIFIED COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â all 6 acceptance criteria checked. TASK #235 (TEST GATE) is NEXT ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â assigned to qa-tester. Critical path: #235 -> #237 (AREA CHECKPOINT).
- [V5.1 FIX 2026-04-06] TASK #234 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â BUG-API-1 webhook CSRF exemption
...
- [V5.1 PLAN 2026-04-06] Debugger Loop Full-App Deep Check ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Phase 2 bulk plan created
  Tasks #234-#237 added to TASK_PLAN.md. BUG-API-1 (HIGH): webhook endpoint blocked by global CSRF middleware ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â assigned to debugger (#234), TEST GATE (#235), AREA CHECKPOINT (#237). BUG-UI-1 (LOW): terminal prompt garble after navigation ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â DEFERRED as known ConPTY artifact per DEC-009 (#236). Next: debugger fixes #234, then qa-tester runs #235 gate, then #237 checkpoint.

- [V5.0 FIX 2026-04-06] TASK #231 COMPLETED + TASK #232 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Swarm snippet preamble filtering and PTY Explosion terminal switching
...
- [FIX 2026-04-05] Duplicate handoff/prompt chain replay partially mitigated in SwarmEngine
  Follow-up analysis on the prompt-delivery stress audit confirmed that the ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€¦Ã¢â‚¬Å“many messages in chainÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â symptom was not only provider verbosity: SwarmEngine could keep parsing a source PTY while the first `_onHandoff()` was still opening the target session. That left a race where repeated PTY redraws or repeated Gemini natural-language handoff text could increment the same edge counter multiple times before the source agent was finally marked done. Fix: the source agent is now marked internal `handoffing` immediately when `_onHandoff()` begins, duplicate `_onHandoff()` calls are ignored once the source has left `running`, and the PTY tap now stops parser/runtime-blocker processing for non-running agents. Regression proof added in `server/tests/swarm-engine.test.js`: repeated Gemini handoff chunks during an in-flight handoff now keep `handoffCount=1` and `edge-ab=1`. Verification: `npm test --prefix server -- swarm-engine.test.js` = 79/79 pass.
...
- [TASK #197 follow-up] Agent terminal snippet fidelity hardened further ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¢ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡Ãƒâ€šÃ‚Â¬ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬Ãƒâ€šÃ‚Â PARTIAL PROGRESS 2026-04-05
...
- [TASK #232 COMPLETED] BUG-WF-3 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â PTY Explosion opens wrong agent terminal after switching nodes ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 2026-04-06
...
- [TASKS #177, #179, #181, #182, #183, #185] V4.0.2 Gemini E2E PTY / UI Bug Fixes ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â CODE FIXES + BLOCKER GATE COMPLETED 2026-04-05
...
- [TASKS #178, #180, #184, #186, #187] V4.0.2 Gemini E2E PTY / UI Bug Fixes ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â REAL GEMINI QA STILL PENDING 2026-04-05
...
- [TASKS #169-#170] V4.1 Per-Harness Model Selection ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-04-05
...
- [TASKS #171-#176] V4.0.1 Gemini Runtime Bug Fixes ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-04-05
  BUG-GEMINI-4 through BUG-GEMINI-7: Fixed 4 Gemini runtime bugs in SwarmEngine.js. 63/63 tests pass. V4.0.1 CLOSED.
## Completed
- [TASKS #160, #162, #164] Gemini CLI Bug-Fix Wave ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â definitive patch (backend+frontend) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-04-04
...
- [TASKS #116-#118] Swarm Bug-Fix Wave ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â post-release patch (frontend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-31
  BUG-SWARM-1: SwarmCanvas.jsx useEffect calls useReactFlow().fitView (setTimeout 50ms) after setNodes/setEdges ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â nodes now centered after generation. BUG-SWARM-2: Removed opacity:0 and staggered CSS animation from node style in PromptToFlowBar.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ReactFlow bounding box measurements now correct. BUG-SWARM-3: workflowDef migrated from SwarmView.jsx local useState to Zustand (useSwarmStore.workflowDef + setWorkflowDef) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â persists across route navigation. BUG-SWARM-4: useSwarm.startExecution already throws Error('No workflow selected') on undefined workflowId ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â confirmed present. Removed orphaned @keyframes fadeIn from index.css. All 4 bugs FIXED.

- [TASKS #114-#115] Toolbar Bug-Fix Wave (frontend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-31
  BUG-TOOLBAR-2: useSwarm.js cleanup useEffect re-keyed on [workflowId] ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â old WebSocket now closed on workflow regen. BUG-TOOLBAR-3: SwarmView.jsx handlePause/handleResume guard against null activeExecutionId ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â no more /null/ URL requests. 187/187 tests pass. All 115 tasks COMPLETED. v3.0.0 fully stable, zero open bugs.

- [TASKS #104-#111] QA Visual Bug-Fix Wave (frontend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-31
...
- [TASK-93/96/97/98] Backend service bug fixes (backend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-28
...
- [TASK-88/90/91] Frontend bug fixes (frontend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-28
...
- [TASK-82] V3 Documentation Update (documenter) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-28
...
- [TASK-81] Build verification + v3.0.0 tag (devops) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-28
...
- [TASK-80-BUGFIX] Swarm route init order bug (debugger) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-28
...
- [TASK-80] V3 End-to-End Test (qa-tester) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-28
  E2E Playwright test of V3 Swarm Orchestrator. 187/187 tests pass. All 6 sidebar views load. SwarmView components verified (PromptToFlowBar, canvas, BreadcrumbBar, AgentInspector). V2 backward compatibility confirmed (Terminal spawns PTY with Claude Code CLI). Scaffold fails gracefully without API key. ONE HIGH BUG FOUND: SwarmEngine route initialization order ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â swarmRoutes and inboxRoutes mounted before SwarmEngine instantiation in server/index.js:231-234 vs 271-272, causing 500 on all execution endpoints.
- [TASK-79] V3 Pre-Release Security Audit (security) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-28
  All 7 SEC-V3 requirements verified as active in production code. Zero CRITICAL/HIGH findings in V3 code. One MEDIUM design note (webhook CSRF interaction ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â net security positive). Two HIGH npm dependency advisories (path-to-regexp, picomatch ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â neither exploitable in current usage). 187/187 tests pass. docs/security-v3-audit.md produced.
- [TASK-78] SwarmEngine Integration Tests (qa-tester) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-28
  server/tests/swarm-engine.test.js created: 19 tests across 7 cases (lifecycle, handoff, circuit breaker, budget, heartbeat, HITL, DEC-009). 187/187 tests pass in 5.62s. SessionManager fully mocked ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â no real PTY.
- [TASK-77] HandoffParser Unit Tests (qa-tester) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-28
...
- [TASK-74] TriggerManager.js ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Webhooks + RSS Polling (backend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-28
  server/services/TriggerManager.js created. Webhook registration, dispatch, RSS polling with SSRF guard. 168/168 tests pass.
- [TASK-62.2] SwarmEngine._onHandoff context injection + status updates (backend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-27
...
### Phase 0 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Foundation (DONE as of 2026-03-18)
- [TASK-1] docs/ARCHITECTURE.md produced by architect ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 2026-03-18
...
- [TASK-2] Monorepo scaffold created by devops ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 2026-03-18
  ...
  PACKAGE CORRECTIONS discovered:
    - node-pty (not node-pty-prebuilt-multiarch) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â prebuilt-multiarch did not resolve; plain node-pty works.
    - write-file-atomic (not write-atomic) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â write-atomic does not exist on npm; correct package is write-file-atomic.
  Both corrected packages are installed in server/node_modules. All subsequent agents must use these names.
- [TASK-3] Server Foundation (backend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
  ...
  Verified: GET /health ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ 200; CSRF guard active; 501 on unimplemented routes.
- [TASK-4] Project Management REST API (backend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
...
- [TASK-5] SessionManager PTY spawn + ring buffer + idle sweeper, WebSocket terminal handler (backend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
...
- [TASK-6] React Sidebar + TerminalView + xterm.js + resize (frontend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
...
- [TASK-7] Entity Management API (backend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
...
- [TASK-8] Entity Management UI (frontend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
...
- [TASK-9] Job Mode API (backend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
...
- [TASK-10] Job Mode UI (frontend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
...
- [TASK-11] Projects View UI (frontend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
...
- [TASK-12] Non-Functional Requirements Polish (backend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
...
### V4.0 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Gemini CLI Harness Integration (COMPLETED 2026-04-04)
_Integration finalized after fixing 3 E2E regressions (BUG-GEMINI-1, 2, 3)._

## Blocked
_None._

- [TASK-14] Pre-Release Security Audit (security) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
...
- [TASK-13] Full QA Test Suite (qa-tester) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
...
### V4.0 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Gemini CLI Harness Integration
- [TASK-154] GEMINI-DISCOVERY-1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Add Gemini CLI binary discovery to BinaryDiscovery.js (COMPLETED 2026-04-04)
- [TASK-155] GEMINI-SCAFFOLD-1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Add Gemini scaffold provider to ScaffoldGenerator.js (COMPLETED 2026-04-04)
- [TASK-156] GEMINI-RUNTIME-1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Add Gemini as a Swarm runtime provider in SwarmEngine.js (COMPLETED 2026-04-04)
- [TASK-157] GEMINI-UI-1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Add Gemini to the Runtime provider dropdown and status indicators in SwarmView (COMPLETED 2026-04-04)
- [TASK-158] GEMINI-BLOCKER-1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Add Gemini interactive PTY blocker and prompt-ready detection tests (COMPLETED 2026-04-04)
- [TASK-159] GEMINI-ROUTE-1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Wire Gemini binary into swarm routes and server startup (COMPLETED 2026-04-04)
- **E2E TEST 2026-04-04: Tasks #154-#159 passed code review but live E2E test with Gemini CLI found 3 bugs:**
  - BUG-GEMINI-1 (CRITICAL): Prompt injection fails ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Gemini Ink TUI treats `\n` as in-field newline, prompt never submitted
  - BUG-GEMINI-2 (MEDIUM): Prompt-ready pattern `esc to interrupt` not emitted by Gemini ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â always falls to 2500ms timer
  - BUG-GEMINI-3 (LOW/cosmetic): Strategy label shows "Auto fallback" before execution regardless of dropdown selection
- [TASK-160] BUG-GEMINI-1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Fix prompt injection for Gemini CLI (PENDING)
- [TASK-161] TEST GATE ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â BUG-GEMINI-1 (PENDING)
- [TASK-162] BUG-GEMINI-2 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Fix prompt-ready detection patterns for Gemini CLI (PENDING)
- [TASK-163] TEST GATE ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â BUG-GEMINI-2 (PENDING)
- [TASK-164] BUG-GEMINI-3 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Fix strategy label cosmetic issue (PENDING)
- [TASK-165] TEST GATE ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â BUG-GEMINI-3 (PENDING)
- [TASK-166] GEMINI-DOCS-1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Update DECISIONS.md, CODE_MAP.md, and ARCHITECTURE.md for Gemini provider (PENDING)
- [TASK-167] TEST GATE ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Gemini CLI harness integration verification (PENDING)
- [TASK-168] AREA CHECKPOINT ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â V4.0 Gemini Harness Full Integration (end-to-end) (PENDING)

### V4.1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Per-Harness Runtime Model Selection
- [TASK-169] FEATURE-MODEL-1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Per-harness model selection UI and backend contract (PENDING)
- [TASK-170] FEATURE-MODEL-2 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Implement per-harness model selection (backend + frontend) (PENDING)

### Phase 7 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â v1.1 Maintenance Backlog (ALL INDEPENDENT, run in parallel)
- [TASK-19] v1.1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Fix JobRunner memory leak ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â backend-dev ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-24
...
- [TASK-20] v1.1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Fix rate limiter memory leak ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â backend-dev ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-24
...
- [TASK-21] v1.1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Upgrade vite to patch esbuild CVE ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â devops ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-24
  MEDIUM-04 FIXED: Upgraded vite from 5.4.21 to 6.4.1 in client/package.json. esbuild CVE
  (GHSA-67mh-4wv8-2f99) resolved ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â npm audit returns 0 vulnerabilities. Build passes (301 modules).
  All 110 tests pass. @vitejs/plugin-react@4.7.0 compatible with vite 6. Files: client/package.json,
  client/package-lock.json.

### Phase 6 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Security Hardening (ALL COMPLETED 2026-03-18)
- [TASK-16] Security hardening ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â replace exec() in openBrowser with shell:false spawn (backend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
  Fixed: server/index.js. openBrowser() now uses spawn with shell:false, detached:true, child.unref(). exec removed.
- [TASK-17] Security hardening ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â validate allowedTools against character whitelist (backend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
  Fixed: server/routes/jobs.js. Added /^[a-zA-Z0-9_,\-]+$/ regex check + 512-char length cap, HTTP 400 on violation.
- [TASK-18] Security hardening ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â validate PID range in ProcessRegistry (backend-dev) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-18
  Fixed: server/services/ProcessRegistry.js. isValidPid() helper (range 1ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ65535), cleanupStale() and register() both guarded.

## V3 Planning Status
**V3 PRD WRITTEN ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 2026-03-27.** docs/PRD.md (version 3.0) complete. Ready for project-manager to build V3 TASK_PLAN and architect to design SwarmEngine. 6 open questions in PRD Section 11 need architect review before implementation.

## Release Status
**v2.0 RELEASE READY ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ALL 31 tasks COMPLETED as of 2026-03-26.**
- v1 (18 tasks, Phase 0ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ6): COMPLETED 2026-03-18.
- v1.1 (3 tasks, Phase 7): COMPLETED 2026-03-24.
  ...
  - TASK-21: Vite 5.4ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢6.4.1 (esbuild CVE MEDIUM-04 resolved)
...
- v2.0 (9 tasks, Phase 9): COMPLETED 2026-03-26.
  ...
  - TASK-31: Visual QA + Functional Regression ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 110/110 tests pass, 299 modules build, 0 critical/high bugs
...
- v2.1 (10 tasks, Phase 10): 9/10 COMPLETED 2026-03-26. TASK-41 (regression QA) pending.
  - TASK-32: CSP fix ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Google Fonts unblocked (fontSrc + styleSrc updated in security.js)
  ...
  - TASK-36: Terminal background #1a1a1a ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢ #000000
...
## Phase 9 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Frontend Redesign (Stitch Design Export)
**Status: COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â All 9 tasks (#23-#31) done as of 2026-03-26.**
- [TASK-23] COMPLETED 2026-03-25 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Design System Foundation (Tailwind config, fonts, CSS, constants) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â frontend-dev
- [TASK-24] COMPLETED 2026-03-25 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â New Sidebar Navigation Component ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â frontend-dev ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â depends on #23
- [TASK-25] COMPLETED 2026-03-26 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Project Dashboard View (replaces ProjectsView) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â frontend-dev
- [TASK-26] COMPLETED 2026-03-26 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Live Terminal Hub View (replaces TerminalView) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â frontend-dev
- [TASK-27] COMPLETED 2026-03-26 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Orchestration Center / Job Runner View (replaces JobView) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â frontend-dev
- [TASK-28] COMPLETED 2026-03-26 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Context & Rules Editor View (new, replaces CLAUDE.md tab) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â frontend-dev
- [TASK-29] COMPLETED 2026-03-26 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Deployment Manager View (new, replaces Agents/Skills tabs) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â frontend-dev
- [TASK-30] COMPLETED 2026-03-26 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â App Shell, Routing, View Integration ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â frontend-dev
- [TASK-31] COMPLETED 2026-03-26 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Visual QA + Functional Regression Testing ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â qa-tester

## Known Issues
- R-01 (RESOLVED): node-pty-prebuilt-multiarch not available ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â plain node-pty used instead
- R-02 (MITIGATED): ConPTY deadlock ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â permanent pty.onData handler enforced in SessionManager (never removed)
- R-04 (FIXED 2026-03-18): AddProjectModal sent POST to nonexistent /api/v1/projects/scaffold ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â fixed to /api/v1/projects with scaffold in body (BUG-03)
- R-05 (FIXED 2026-03-18): projects/session API responses not destructured in Sidebar and ProjectsView ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â all .map() calls were crashing (BUG-04, BUG-05)
- R-06 (FIXED 2026-03-18): WS_BASE hardcoded to port 3000 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â fixed to window.location.port (BUG-16)
- R-07 (FIXED 2026-03-18): ws.bufferedAmount undefined server-side (browser API) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â backpressure guard was always false; fixed to ws._socket.bufferSize (BUG-11)
...
- R-10 (FIXED 2026-03-24): JobRunner #jobs Map memory leak ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â completed jobs now auto-evicted after 10min TTL (BUG-06, TASK-19)
- R-11 (FIXED 2026-03-24): Rate limiter _rateLimitMap stale sweep added ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 60s interval cleans expired entries (BUG-07, TASK-20)
- R-03 (RESOLVED): Job mode process hang if child.stdin.end() not called ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â enforced in Task #9 (JobRunner.js line after spawn)
- NOTE: FileManager was NOT created in Task #5 as planned ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â RESOLVED in Task #7 (created server/services/FileManager.js).

## V3 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Swarm Orchestrator (57 granular tasks after split ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 2026-03-27 replan)
**Status: 46/57 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â as of 2026-03-28. All Phase 1 backend tasks done. All Phase 2 (Canvas Static) COMPLETED. Phase 3 (Prompt-to-Flow) FULLY COMPLETED. Phase 4 (Live Execution) ACTIVE: #62.1, #62.2, #62.3, #63, #64, #66, #67 DONE. Phase 5 wave: #68, #69, #70, #71.1, #71.2, #73 DONE. Phase 6 (Trigger Nodes): #74, #75, #76 ALL COMPLETED.**
**Note: Original 40 tasks (#43ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ#82). After model assignment + subtask split: 57 granular units.**
**7 original tasks split into subtasks: #46ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢3, #47ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢2, #48ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢2, #53ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢3, #57ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢2, #62ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢3, #71ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢2**
- V3 PRD complete: docs/PRD.md
- V3 research complete: docs/research_complete.md, research_a/b/c.md
- V3 task plan: docs/TASK_PLAN.md tasks #43ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ#82 (with subtasks .1/.2/.3)

### V3 Phase 1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Backend Foundation
- [TASK-43] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â WorkflowStore.js ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 132/132 tests pass
- [TASK-44] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â workflows.js CRUD routes (routes mounted, CRUD working)
- [TASK-45] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â HandoffParser.js ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 22 unit tests, 132/132 tests pass
- [TASK-46.1] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SwarmEngine ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SessionManager patch + class skeleton, 132/132 tests pass
- [TASK-46.2] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SwarmEngine ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â startExecution + _spawnAgentPty + HandoffParser tap, 132/132 tests pass
- [TASK-46.3] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SwarmEngine ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â _buildSystemPrompt + _startHeartbeat, 132/132 tests pass
- [TASK-47.1] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â swarm.js ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â 7 execution control endpoints, scaffold stub (501), mounted at /api/v1/swarm, 132/132 tests pass
- [TASK-47.2] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â swarm.js ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â scaffold stub (501) confirmed present from #47.1; no code changes needed; 132/132 tests pass
- [TASK-48.1] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â swarmHandler.js ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â channel routing + connection management; dual noServer WSS routing via server.on('upgrade'); 132/132 tests pass
- [TASK-48.2] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â swarmHandler.js broadcast() + WS event wiring; broadcast() named export added; setWsBroadcast(broadcast) called in server/index.js; 132/132 tests pass
- [TASK-49] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â CircuitBreaker.js + BudgetTracker.js ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â pure service classes, 132/132 tests pass
- [TASK-49] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â CircuitBreaker.js + BudgetTracker.js ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â pure service classes, no I/O, no imports, 132/132 tests pass
- [TASK-50] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â V3 Security Layer (SEC-V3-01 to SEC-V3-07) ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â ssrfGuard.js, webhookLimit.js, webhookRateLimit.js, hitlValidation.js created; SEC-V3-02/-06/-07 verified in WorkflowStore.js + HandoffParser.js; 36 new tests; 168/168 pass

### V3 Phase 2 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Canvas Static
- [TASK-51] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â @xyflow/react@12.10.1 + zustand@4.5.7 installed in client/; 299 modules build clean; 132/132 tests pass ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â devops agent
- [TASK-52] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SwarmContext.jsx Zustand ExecutionStore ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â client/src/store/SwarmContext.jsx created; useSwarmStore Zustand store with execution state, canvas navigation, HITL inbox, inter-agent feed, breadcrumb stack. Build clean (299 modules).
- [TASK-53.1] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â AgentNode.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â client/src/canvas/nodes/AgentNode.jsx created; reads agentStates from useSwarmStore, renders status colors, handles/label/snippet/handoffCount. Build clean (299 modules).
- [TASK-53.2] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â DepartmentNode.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â client/src/canvas/nodes/DepartmentNode.jsx created; group container node with focused/selected state, setFocusedDepartment click, agentCount badge. Build clean (299 modules).
- [TASK-53.3] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â TriggerNode.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â client/src/canvas/nodes/TriggerNode.jsx created; source-only Handle, purple theme, webhook (ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â) / rss (ÃƒÆ’Ã‚Â°Ãƒâ€¦Ã‚Â¸ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œÃƒâ€šÃ‚Â¡) icon mapping, selected ring. Build clean (299 modules).
- [TASK-54] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â HandoffEdge.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â client/src/canvas/edges/HandoffEdge.jsx created; animated dashed blue line + counter badge driven by useSwarmStore edgeCounters[id]; @keyframes dashdraw added to index.css. Build clean (299 modules).
- [TASK-55] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â AgentInspector.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â client/src/canvas/AgentInspector.jsx created; reads selectedNodeId/agentStates/setSelectedNode from SwarmStore; shows label, type badge, live status, handoffCount, systemPrompt, lastOutputSnippet; empty state when nothing selected. Build clean (299 modules).
- [TASK-56] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â BreadcrumbBar.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â client/src/canvas/BreadcrumbBar.jsx created; root "All Agents" crumb always shown, department crumbs from departmentStack with label resolution from nodes prop, last crumb bold/white, navigateBreadcrumb(index) on click. Build clean (299 modules).
- [TASK-57.1] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SwarmCanvas.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â React Flow canvas with drill-down filtering; registers agent/department/trigger nodeTypes + handoff edgeType; useMemo drill-down filters nodes by focusedDepartmentId; onNodeClick/onPaneClick wired to SwarmStore; BreadcrumbBar + AgentInspector mounted. Build clean (299 modules).
- [TASK-57.2] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SwarmView.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â full-page layout shell; toolbar with executionStatus indicator (idle/running/stopped) + conditional Reset button; ReactFlowProvider wraps SwarmCanvas; workflowDef as useState(null) pending #61. Build clean (299 modules).
- [TASK-58] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â App.jsx + Sidebar swarm nav; SwarmView imported and added to switch; 'hub' icon + 'Swarm' label added to NAV_ITEMS in constants.js (Sidebar auto-renders dynamically from NAV_ITEMS). No extra ReactFlowProvider needed ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SwarmView already wraps SwarmCanvas with its own. Build: 470 modules, 0 errors. 168/168 tests pass.

### V3 Phase 3 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Prompt-to-Flow
- [TASK-59] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â scaffold endpoint: generateWorkflowFromPrompt() + Claude claude-haiku-4-5-20251001 + WorkflowStore.create(); @anthropic-ai/sdk installed; 168/168 tests pass
- [TASK-60] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â PromptToFlowBar.jsx + staggered animation ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â PromptToFlowBar.jsx created, @keyframes fadeIn added to index.css, SwarmView.jsx wired; 471 modules build clean
- [TASK-61] COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â useWorkflow.js CRUD hook ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â client/src/hooks/useWorkflow.js created; uses apiGet/apiPut/apiDelete wrappers; useWorkflow(id) + useWorkflowList() exports; build: 470 modules, 0 errors

### V3 Phase 4 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Live Execution
- [TASK-62.1] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SwarmEngine _onHandoff: full implementation verified (context merge, edge counter, circuit breaker advisory, handoffCount, _ensureAgentPty). 168/168 tests pass.
- [TASK-62.1] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SwarmEngine _onHandoff steps 1-4: context merge, edge counter, circuit breaker advisory, _ensureAgentPty. 168/168 tests pass.
- [TASK-62.2] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SwarmEngine _onHandoff: context injection + agent status updates. 168/168 tests pass.
- [TASK-62.3] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SwarmEngine _onDone (dual WS events) + BudgetTracker.registerSession wiring + lastOutputSnippet verified. 168/168 tests pass.
- [TASK-63] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â useSwarm.js WS hook for execution control
- [TASK-64] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â useHandoff.js edge animation hook
- [TASK-65] PENDING ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â AgentNode live updates ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â pulse + micro PTY log
- [TASK-66] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â BroadcastBar.jsx + broadcast route ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â client/src/canvas/BroadcastBar.jsx created; mounted at bottom of SwarmView.jsx after ReactFlowProvider; returns null unless executionStatus==='running'; POSTs to /api/v1/swarm/:executionId/broadcast with {text, scope:'all', mode}; soft/hard mode selector; 3s result feedback; build: 472 modules, 0 errors
- [TASK-67] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SwarmEngine heartbeat ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â idle sweeper prevention

### V3 Phase 5 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â HITL + PTY Explosion
- [TASK-68] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â inbox.js HITL approve/reject API (server/routes/inbox.js created, mounted at /api/v1/swarm, 168/168 tests pass)
- [TASK-69] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â HitlInbox.jsx approval panel created (client/src/panels/HitlInbox.jsx); list view with type badges, Approve/Reject flow, inline resume textarea, empty state, getPendingCount export; 472 modules, 0 errors
- [TASK-70] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SwarmEngine freezeAgent/unfreezeAgent HITL methods added; 168/168 tests pass
- [TASK-71.1] COMPLETED 2026-03-27 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â PTY Explosion overlay component (frontend-dev, sonnet; dep: #58 ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ)
- [TASK-71.2] COMPLETED 2026-03-28 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â PTY Explosion Escape key handler (frontend-dev, haiku; 473 modules, 0 errors)
- [TASK-72] COMPLETED 2026-03-28 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â InterAgentFeed.jsx real-time handoff log (frontend-dev, haiku; dep: #52 ÃƒÆ’Ã‚Â¢Ãƒâ€¦Ã¢â‚¬Å“ÃƒÂ¢Ã¢â€šÂ¬Ã…â€œ)
- [TASK-73] COMPLETED 2026-03-28 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â useInbox.js HITL polling hook (client/src/hooks/useInbox.js; polling + approve/reject actions; 473 modules, 0 errors)

### V3 Phase 6 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Trigger Nodes
- [TASK-74] COMPLETED 2026-03-28 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â TriggerManager.js webhooks + RSS polling
- [TASK-75] COMPLETED 2026-03-28 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â triggers.js routes
- [TASK-76] COMPLETED 2026-03-28 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â TriggerNode.jsx full visual implementation

### V3 Phase 7 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â QA + Security + Release
- [TASK-77] COMPLETED 2026-03-28 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â HandoffParser unit tests (qa-tester)
- [TASK-78] COMPLETED 2026-03-28 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â SwarmEngine integration tests (qa-tester)
- [TASK-79] COMPLETED 2026-03-28 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â V3 Pre-Release Security Audit (security)
- [TASK-80] COMPLETED 2026-03-28 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â V3 End-to-End Test (qa-tester, Puppeteer)
- [TASK-81] COMPLETED 2026-03-28 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Build verification + v3.0.0 git tag (devops)
- [TASK-82] COMPLETED 2026-03-28 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â V3 Documentation update (documenter)

- [TASK-65] AgentNode Live Updates ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â frontend-dev ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â COMPLETED 2026-03-27
...
- [V4.0.4 NO-OP 2026-04-06] TASK #203 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â BUG-RECOVERY-LABELING-1 already resolved
...
### V5 Wave 1 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Swarm Editor Transition (2026-04-06)
- V5 Wave 1 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Canvas transitions from viewer to full visual editor.
...
- Modified: SwarmCanvas.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â undo/redo integration, delete with cascade (department children), context menu (add/duplicate/copy/paste/delete), dirty tracking via markDirty/onCanvasChange callbacks, node drag history
- Modified: AgentInspector.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â full edit panel with per-type config sections (AgentFields, DepartmentFields, TriggerFields), debounced field commits, collapsible sections, editable label header
- Modified: SwarmView.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â save button with sanitizeWorkflow, dirty state indicator (*), inline-editable workflow name with validation, save success/error feedback banners
- Modified: useWorkflow.js ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â bug fix: update() now unwraps {workflow} response envelope from server PUT
...
### V5 Wave 2 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â NodePalette + WorkflowSettingsModal (2026-04-06)
- V5 Wave 2 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Drag-and-drop node palette and workflow settings modal.
...
- Modified: SwarmCanvas.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â onDragOver/onDrop handlers for NodePalette integration
- Modified: SwarmView.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â gear Settings button, WorkflowSettingsModal wiring
- FRs covered: FR-V5-25 through FR-V5-29 (node palette), FR-V5-34/35/36 (workflow settings)

### V5 Wave 3 ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Validation + Shortcuts + Snap-to-Grid + Export/Import/Duplicate (2026-04-06)
- V5 Wave 3 COMPLETED ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â Canvas validation, keyboard shortcuts, snap-to-grid, and workflow export/import/duplicate.
...
- Modified: SwarmCanvas.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â snapToGrid enabled (20px grid), snapGrid={[20, 20]} prop added to ReactFlow
- Modified: AgentNode.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â validation warning badge (amber circle with !) for empty system prompts (FR-V5-45)
- Modified: SwarmView.jsx ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â export (FR-V5-38: download as JSON), import (FR-V5-39: upload JSON + create via API), duplicate (FR-V5-37: clone workflow), keyboard shortcuts (FR-V5-43: Ctrl+S save, Ctrl+Enter run), validation banner + run guard (FR-V5-44/46), stable refs for shortcut handlers
...
- [DEBUG FIX 2026-04-08] Swarm chat fidelity hardening continued. `SwarmEngine` now fixes additional live ConPTY artifacts seen in the Parallel Greetings workflow (`contains`, `greeting in one language`, `Agent-B` label joins, `duplicherÃƒÆ’Ã‚Â  l'handoff`, compact English phrase joins). `ChatExtractor` now strips much more Codex fallback chrome from Unified Chat, including `Working (...)`, `@filename` prompt traces, `[default]` subagent lines, `/fast` tips, and garbled short-fragment TUI bursts. Regression status: `npm test --prefix server -- ChatExtractor.test.js swarm-engine.test.js` PASS (153/153). Live browser smoke on fresh ports `3010`, `3011`, `3012`: massive Codex fallback chat contamination is greatly reduced; residual risk remains that the fallback path may now under-show some intermediate semantic progress and currently still surfaces `Structured handoff sent.` as the only visible chat item in the observed window.
- [PM 2026-04-08] TASK #367 PASS ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â V9.0 Phase 1 Backend Core CLOSED. Verified mixed-provider chain (Claude stream-json -> Claude stream-json -> Codex PTY), graceful stop behavior, backend suite PASS at 472/472, and root build PASS (client build 500 modules). Status now 357/393 COMPLETED, 2 DEFERRED, 34 PENDING. Phase 2 FRONTEND is READY starting at #368 (SwarmContext.jsx).
